export const apiRoutes = {
    ...
    emploiApp: {
      ...
      jobOpportunitiesDetail: (id: number) => `job-opportunities/${id}/`,
      requiredSkillsListCreate: 'required-skills/',
      requiredSkillsDetail: (id: number) => `required-skills/${id}/`,
      requiredLanguagesListCreate: 'required-languages/',
      requiredLanguagesDetail: (id: number) => `required-languages/${id}/`,
      jobApplicationsListCreate: 'job-applications/',
      jobApplicationsDetail: (id: number) => `job-applications/${id}/`,
    },
    equipeApp: {
