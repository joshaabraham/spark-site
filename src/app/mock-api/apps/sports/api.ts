...
import { categories as categoriesData, courses as coursesData, demoCourseSteps as demoCourseStepsData } from 'app/mock-api/apps/sports/data';

@Injectable({
    providedIn: 'root'
})
export class SportsMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('api/apps/sports/categories')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/sports/courses/course')
            .reply(({request}) => {
